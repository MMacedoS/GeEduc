                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="fw-bold"> <?= $professor->name ?? 'não identificado' ?>
                                        </td>
                                        <td class="d-none d-xl-table-cell d-lg-table-cell d-md-table-cell">
                                            <?= $professor->email ?? 'não identificado' ?>
                                        </td>
                                        <td class="d-none d-xl-table-cell d-lg-table-cell d-md-table-cell">
                                            ...
                                            <td>
                                                <div class="d-none d-xl-flex d-lg-flex d-md-flex">
                                                    <? if (hasPermission('editar_professor')) { ?>
                                                        <a class="mb-1 me-2 mt-1" href="/professores/<?= $professor->id ?>/editar">
                                                    ...
                                                    <? if (hasPermission('visualizar_turmas_estudantes')) { ?>
                                                        <a class="mb-1 me-2 mt-1" href="/professores/<?= $professor->id ?>/disciplina">
                                                            <div class="border p-2 rounded-3">
                                                    ...
                                                    <? if (hasPermission('deletar_professor')) { ?>
                                                        <button class="btn btn-outline btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal_<?= $professor->id ?>">
                                                            <div class="border p-2 rounded-3">
                                                ...
                                                <div class="d-block d-xl-none d-lg-none d-md-none dropdown ms-3">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <div class="header-action-links float-end">
                                                            ...
                                                            <? } ?>
                                                            <? if (hasPermission('visualizar_turmas_estudantes')) { ?>
                                                                <a class="mb-1 me-0 mt-1" href="/professores/<?= $professor->id ?>/disciplina">
                                                                    <div class="border p-2 rounded-3">
                                                                        <i class="icon-link fs-5"></i>
                                                                    </div>
                                                                </a>
                                                ...
                                                <div class="modal fade" id="exampleModal_<?= $professor->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" onclick="deleteData('/professores/<?= $professor->id ?>')" class="btn btn-danger">Confirmar Exclusão</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
