...
<div class="row gx-3">
    <div class="col-8 col-xl-6">
        ...
        <ol class="breadcrumb mb-3">
            ...
            <li class="breadcrumb-item">Recuperação do Componente: <?= getJsonToObject($turmas_disciplinas[0]->professor_disciplina)->disciplina->nome ?></li>
        </ol>
        <!-- Breadcrumb end -->
    </div>
                                            ...
                                            <? foreach ($semester_1 as $index => $value) : ?>
                                                <a href="#"
                                                    ...
                                                    <div class="d-flex gap-2 w-100 justify-content-between align-items-start">
                                                        <div>
                                                            <h6 class="mb-0"><?= getJsonToObject($value->estudantes)->nome ?></h6>
                                                        ...
                                                        <form class="modal-content" method="post" action="/meus-componentes/turma/<?= $turma->uuid ?>/disciplina/<?= $turmas_disciplinas[0]->uuid ?>/recuperacao">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalNotaLabel<?= $index ?>">
                                                                    Lançar Recuperação I Semestre - <?= getJsonToObject($value->estudantes)->nome ?>
                                                                </h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea name="obs" id="detalhamento<?= $index ?>" class="form-control" rows="3"><?= $value->obs ?></textarea>
                                                                </div>
                                                            </div>
