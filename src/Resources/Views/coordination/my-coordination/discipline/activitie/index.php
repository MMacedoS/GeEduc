                            ...
                            <tbody>
                                <? foreach ($atividades as $atividade) { 
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <? if (hasPermission('professor')) {?>
                                            <a class="mb-1 me-2 mt-1" href="/minha-coordenacao/turma/<?=$turma->uuid?>/disciplina/<?=$turmas_disciplinas[0]->uuid?>/atividade/<?=$atividade->uuid?>">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" 
                                                                onclick="deleteData('/minha-coordenacao/turma/<?=$turma->uuid?>/disciplina/<?=$turmas_disciplinas[0]->uuid?>/atividade/<?=$atividade->uuid?>')" 
