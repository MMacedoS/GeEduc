...
Um sistema de gestão escolar desenvolvido em **PHP Puro** aplicando **POO**, **MVC**, **SOLID**, **Singleton**, **JWT** e **Clean Code**.  
Interface estilizada com **Bootstrap** e arquitetura modular para fácil manutenção e escalabilidade.
