...
<html>
<head>
<title><?php echo "Boleto - " . getJsonToObject($estudante_mensalidade->estudantes)->nome; ?></title>
...
#instr_header {
	background: url('<?=URL_PREFIX_APP?>/Public/images/logobb.jpg') no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
<div id="container">
	...
	<div id="boleto">
        ...
        <table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD class=ct width=666><div align=right><b class=cp>Recibo do Sacado</b></div></TD></tr></tbody></table>
            ...
            <tbody>
            <tr>
                <td width=150><IMG SRC="<?=URL_PREFIX_APP?>/Public/images/logobb.jpg"></td>
                <td width=50>
            <div class="field_cod_banco"><?php echo '001'; ?></div>
                </td>
                <td class="linha_digitavel"><?php echo $boleto->codigo_barras ?></td>
            </tr>
            </tbody>
            </table>
            ...
            <tr class="campos">
                <td class="cedente"><?php echo RESPONSAVEL_FINANCEIRO; ?>&nbsp;</td>
                <td class="ag_cod_cedente"><?php echo getJsonToObject($boleto->boleto)->data->beneficiario->agencia . '/' . getJsonToObject($boleto->boleto)->data->codigoCliente?> &nbsp;</td>
                <td class="especie"><?php echo 'dinheiro'?>&nbsp;</td>
                <TD class="qtd"><?php echo 1?>&nbsp;</td>
                <TD class="nosso_numero"><?php echo getJsonToObject($boleto->boleto)->data->numero?>&nbsp;</td>
            </tr>
            </tbody>
            </table>
            ...
            <tr class="campos">
                <td class="num_doc"><?php echo getJsonToObject($boleto->boleto)->data->codigoCliente?></td>
                <td class="contrato"><?php echo getJsonToObject($boleto->boleto)->data->codigoCliente?></td>
                <td class="cpf_cei_cnpj"><?php echo RESPONSAVEL_FINANCEIRO_CPF?></td>
                <td class="vencimento"><?php echo brDate($mensalidade->data_vencimento)?></td>
                <td class="valor_doc"><?php echo brCurrency($mensalidade->valor)?></td>
            </tr>
        </tbody>
        </table>
            ...
            <tr class="campos">
                <td class="sacado"><?php echo getJsonToObject($estudante_mensalidade->estudantes)->responsavel_nome?> <br> 
                    <?php echo getJsonToObject($estudante_mensalidade->estudantes)->responsavel_doc?> <br>
                    referente ao estudante: <?php echo getJsonToObject($estudante_mensalidade->estudantes)->nome?>
                </td>
            </tr>
            </tbody>
            </table>
            ...
            <tr class="campos">
                ...
                <td class="vencimento2"><?php echo brDate($mensalidade->data_vencimento)?></td>
            </tr>
            </tbody>
            </table>
            ...
            <tr class="campos">
                <td class="data_doc"><?php echo brDateHora($mensalidade->created_at);?></td>
                <td class="num_doc2"><?php echo getJsonToObject($boleto->boleto)->data->codigoCliente?></td>
                <td class="especie_doc"><?php echo 'MENSALIDADE ESCOLAR'?></td>
                <td class="aceite">A</td>
                <td class="data_process"></td>
                <td class="nosso_numero2"><?php echo getJsonToObject($boleto->boleto)->data->numero?></td>
            </tr>
            </tbody>
            </table>
            ...
            <tr class="campos">
                ...
                <td class="carteira">17 / 019</td>
                <td class="especie2">dinheiro</td>
                <td class="qtd2"><?php echo '1'?></td>
                <td class="xvalor"><?php echo brCurrency($mensalidade->valor)?></td>
                <td class="valor_doc2"><?php echo brCurrency($mensalidade->valor)?></td>
            </tr>
            </tbody>
            </table>
            ...
            <tr><td class="last_line" rowspan="6">
                ...
                <tr class="campos">
                    ...
                    <img src="https://quickchart.io/qr?text=<?=$boleto->pix?>&size=100" alt="QR Code PIX">
                    </td>
                </tr>
                </tbody>
                </table>
            ...
            <tr class="campos">
                <td class="sacado2">
                    <p>
                        <?php echo getJsonToObject($estudante_mensalidade->estudantes)->responsavel_nome?> <br> 
                        <?php echo getJsonToObject($estudante_mensalidade->estudantes)->responsavel_doc?> <br>
                        referente ao estudante: <?php echo getJsonToObject($estudante_mensalidade->estudantes)->nome?>
                    </p>
                </td>
...
<script>
        // Dados do boleto e PIX
        const codigoBarras = "<?=getJsonToObject($boleto->boleto)->data->codigoBarraNumerico?>"; // Exemplo de código de barras
        ...
        function downloadPDF() {
            ...
            html2pdf().from(element).save('boleto.pdf'); // Converte o conteúdo para PDF e baixa
        }
