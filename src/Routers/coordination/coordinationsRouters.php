...
$router->create('GET', "/minha-coordenacao/turma/{turma_id}/estudantes", [$coordenadorController, 'indexStudents'], $auth);

$router->create('GET', "/minha-coordenacao/turma/{turma_id}/recuperacoes", [$recuperacaoController, 'indexByCoordenator'], $auth);
