...
<div class="row gx-3">
    <div class="col-8 col-xl-6">
        ...
        <ol class="breadcrumb mb-3">
            ...
            <li class="breadcrumb-item">
                <i class="icon-house_siding lh-1"></i>
                <a href="\minha-coordenacao/turma/<?= $turma->id ?>/disciplinas" class="text-decoration-none">Disciplinas Turma: <?= $turmas_disciplinas ?? 'não identificado' ?></a>
            </li>
            <li class="breadcrumb-item">
                <i class="icon-archive lh-1"></i>
                <a href="/minha-coordenacao/turma/<?= $turma->id ?>/disciplinas" class="text-decoration-none">Atividades dos Componentes</a>
            </li>
                ...
                <div class="card-body">
                    <div class="m-0">
                        ...
                        <select class="form-control" name="type" id="type">
                            ...
                            <option value="A-1" <?php if (isset($atividade->tipo)  && $atividade->tipo == 'A-1') {
                                                    echo 'selected';
                                                } ?>>Atividade 1</option>
                            <option value="A-2" <?php if (isset($atividade->tipo)  && $atividade->tipo == 'A-2') {
                                                    echo 'selected';
                                                } ?>>Atividade 2</option>
                            <option value="A-3" <?php if (isset($atividade->tipo)  && $atividade->tipo == 'A-3') {
                                                    echo 'selected';
                                                } ?>>Atividade 3</option>
                            <option value="A-4" <?php if (isset($atividade->tipo)  && $atividade->tipo == 'A-4') {
                                                    echo 'selected';
                                                } ?>>Atividade 4</option>
                        </select>
                    </div>
                ...
                <div class="card-body">
                    <div class="m-0">
                        ...
                        <select name="active" class="form-control" id="">
                            <option value="0" <?php if (isset($atividade->ativo)  && $atividade->ativo == '0') {
                                                    echo 'selected';
                                                } ?>>Impedido</option>
                            <option value="1" selected <?php if (isset($atividade->ativo)  && $atividade->ativo == '1') {
                                                            echo 'selected';
                                                        } ?>>Disponivel</option>
                        </select>
                    </div>
