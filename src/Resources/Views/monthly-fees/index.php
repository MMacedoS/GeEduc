                   ...
                   <div class="accordion-item">
                        <h2 class="accordion-header" id="headingSpecialTitleTwo">
                          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#estudante_<?=$mensalidade->estudante_mensalidade_id?>" aria-expanded="false"
                            aria-controls="collapseSpecialTitleTwo">
                            <h5 class="m-0"><?= getJsonToObject($mensalidade->estudante_mensalidade)->estudante->nome?></h5>
                          </button>
                        </h2>
                        <div id="estudante_<?=$mensalidade->estudante_mensalidade_id?>" class="accordion-collapse collapse"
                                            ...
                                            <div class="table-outer">
                                                <div class="table-responsive">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tbody>
                                                        <? 
                                                        if(!empty(getJsonToObject($mensalidade->mensalidades))) {
                                                            foreach (getJsonToObject($mensalidade->mensalidades) as $estudante_mensalidade) {
                                                            ?>
                                                                <tr>
                                                ...
                                                <div class="text-end ">
                                                    Total <b><?=count(getJsonToObject($mensalidade->mensalidades))?></b> registros
                                                </div>
                                            </div>
                                        </div>
                                    </div>
