                                            ...
                                            <td>
                                                <div class="d-none d-xl-flex d-lg-flex d-md-flex">
                                                    <? if (hasPermission('editar_estudante')) { ?>
                                                        <a class="mb-1 me-2 mt-1" href="/estudante/<?= $estudante->id ?>">
                                                    ...
                                                    <? if (hasPermission('visualizar_turmas_estudantes')) { ?>
                                                        <a class="mb-1 me-2 mt-1" href="/estudantes/<?= $estudante->id ?>/turma">
                                                            <div class="border p-2 rounded-3">
                                                    ...
                                                    <? if (hasPermission('visualizar_mensalidades')) { ?>
                                                        <a class="mb-1 me-2 mt-1" href="/estudantes/<?= $estudante->id ?>/mensalidades">
                                                            <div class="border p-2 rounded-3">
                                                    ...
                                                    <? if (hasPermission('deletar_estudante')) { ?>
                                                        <button class="btn btn-outline btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal_<?= $estudante->id ?>">
                                                            <div class="border p-2 rounded-3">
                                                ...
                                                <div class="modal fade" id="exampleModal_<?= $estudante->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p>Estudante: <?= $estudante->student_name ?></p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                                <button type="button" onclick="deleteData('/estudante/<?= $estudante->id ?>')" class="btn btn-danger">Confirmar Exclusão</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
