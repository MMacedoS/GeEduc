                                            ...
                                            <td>
                                                <div class="d-none d-xl-flex d-lg-flex d-md-flex">
                                                    <? if (hasPermission('editar_turma')) { ?>
                                                        <a class="mb-1 me-2 mt-1" href="/turma/<?= $turma->id ?>">
                                                    ...
                                                    <? if (hasPermission('visualizar_turmas_estudantes')) { ?>
                                                        <a class="mb-1 me-2 mt-1" href="/turmas/<?= $turma->id ?>/disciplinas">
                                                            <div class="border p-2 rounded-3">
                                                    ...
                                                    <? if (hasPermission('deletar_turma')) { ?>
                                                        <button class="btn btn-outline btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal_<?= $turma->id ?>">
                                                            <div class="border p-2 rounded-3">
                                                ...
                                                <div class="modal fade" id="exampleModal_<?= $turma->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" onclick="deleteData('/turma/<?= $turma->id ?>')" class="btn btn-danger">Confirmar Exclusão</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
