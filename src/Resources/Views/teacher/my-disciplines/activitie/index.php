    ...
    <div class="col-4 col-xl-6">
        <div class="float-end">
            <? if (hasPermission('cadastrar_atividade') || hasPermission('professor')) { ?>
                <a href="/meus-componentes/<?= $turma->id ?>/disciplina/<?= $turmas_disciplinas->id ?>/atividade" class="btn btn-outline-primary"> + </a>
            <? } ?>
        </div>
    </div>
</div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <? if (hasPermission('professor')) { ?>
                                            <td class="d-flex">
                                                <? if (hasPermission('professor')) { ?>
                                                    <a class="mb-1 me-2 mt-1" href="/meus-componentes/<?= $turma->id ?>/disciplina/<?= $turmas_disciplinas->id ?>/atividade/<?= $atividade->id ?>">
                                                ...
                                                <? } ?>
                                                <? if (hasPermission('professor')) { ?>
                                                    <button class="btn btn-outline btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal_<?= $atividade->id ?>">
                                                        <div class="border p-2 rounded-3">
                                                            <span class="fs-5 text-danger icon-delete1"></span>
                                                        </div>
                                                    </button>
                                                <? } ?>
                                                <div class="modal fade" id="exampleModal_<?= $atividade->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p>Atividade: <?= $atividade->title ?? 'não identificado' ?></p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                                <button type="button"
                                                                    onclick="deleteData('/meus-componentes/<?= $turma->uuid ?>/disciplina/<?= $turmas_disciplinas->id ?>/atividade/<?= $atividade->id ?>')"
